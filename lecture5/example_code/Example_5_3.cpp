...
int main(int argc, char* argv[])
{
	...
	else
	{
		...
		//doing a simple copy rather than a get on process zero - I am doing this inside the post - wait to give process zero at least a little bit to do while the communications are completing
		for (int n = 0; n < chunk_size; n++)

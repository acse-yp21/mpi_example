...
int main(int argc, char* argv[])
{
	...
	if (id == 0)
	{
		...
		//while I could have used a single loop, I have split it between an outer loop for each process and an inner loop for the data belonging to a given process
		for (int i = 0; i < p; i++)
		{

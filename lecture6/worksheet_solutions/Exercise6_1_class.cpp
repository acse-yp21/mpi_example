...
//Note that this is the solution to 6_1b (a is a somewhat simpler process than this one)
...
private:
	...
	//Also note that, while the vector of vectors has some advantages in terms of ease of coding, its 
	//big disadvantage from an efficiency perspective is that the row data is discontiguous
	int rows, columns;
